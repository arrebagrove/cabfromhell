...
namespace CabFromHell.Backend.Morpheus.IngestService
{
        ...
        private static void Main()
        {
            try
            {
                ...
                using (FabricRuntime fabricRuntime = FabricRuntime.Create())
                {
                    ...
                    fabricRuntime.RegisterServiceType("IngestServiceType", typeof(IngestService));

                    ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(IngestService).Name);
