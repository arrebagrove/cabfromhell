...
namespace CabDriverActorService
{
    ...
    internal class CabDriverActorService : StatefulActor<CabDriverActorService.ActorState>, ICabDriverActorService
    {
        ...
        internal sealed class ActorState
        {
            ...
            {
                return string.Format(CultureInfo.InvariantCulture, "CabDriverActorService.ActorState[Count = {0}]", Count);
            }
        }
        ...
        [Readonly]
        Task<int> ICabDriverActorService.GetCountAsync()
        {
        ...
        Task ICabDriverActorService.SetCountAsync(int count)
        {
