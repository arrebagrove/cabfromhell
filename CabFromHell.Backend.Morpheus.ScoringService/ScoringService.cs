...
namespace CabFromHell.Backend.Morpheus.ScoringService
{
    ...
    /// </remarks>
    internal class ScoringService : StatefulActor<ScoringService.ActorState>, IScoringService
    {
        /// <summary>
        ...
        internal sealed class ActorState
        {
            ...
            {
                return string.Format(CultureInfo.InvariantCulture, "ScoringService.ActorState[Count = {0}]", Count);
            }
        }
        ...
        [Readonly]
        Task<int> IScoringService.GetCountAsync()
        {
