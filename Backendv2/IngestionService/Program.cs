        ...
        private static void Main()
        {
            try
            {
                ...
                using (FabricRuntime fabricRuntime = FabricRuntime.Create())
                {
                    ...
                    fabricRuntime.RegisterServiceType("IngestionServiceType", typeof(IngestionService));

                    ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(IngestionService).Name);
